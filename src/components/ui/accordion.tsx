		...
		>
			...
			>
				...
				>
					...
					<path
						className={cn(
							"origin-center transition-[opacity,scale] duration-150 ease-in-out-quad",
							"in-data-panel-open:scale-0 in-data-panel-open:opacity-0"
						)}
						d="M4 10L16 10"
						stroke="currentColor"
						strokeLinecap="round"
	...
	return (
		<Accordion.Panel
			className={cn(
				...
				"transition-[height] duration-150 ease-in-out-quad",
